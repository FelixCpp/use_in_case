...
void main() {
  group('before', () {
    ...
    test('should call "before" with correct parameter', () async {
      ...
      final result = await sut.before((input) async => parameter = input).getOrThrow('42');
    ...
    test('should call "before" in correct order', () async {
      ...
      final result = await sut.before((_) async => order.add(1)).before((_) async => order.add(0)).getOrThrow('42');
    ...
    test('should call "before" until first throws', () async {
      ...
      await expectLater(
        () => sut.before((_) async => callCount++).before((_) async => throw Exception()).before((_) async => callCount++).getOrThrow('42'),
        throwsException,
      );
